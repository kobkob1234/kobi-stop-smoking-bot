...
export const DEFAULT_META = {
  ...
  // ═══ מראה של מצב ה-CBT, לא מקור ═══
  //
  // הסשנים רצים בסוכן, והבעלוּת על `sessionsDone` שייכת לקובץ
  // (`cbt-state/session-state.json`). בלי מראה כאן הבוט לא יודע שסשן
  // רץ — וימשיך להזכיר עליו לנצח.
  //
  // **נכתב רק דרך `/cbt-state`**, לעולם לא מהטיק ולא מטיפול בהודעה.
  // זה מה שמונע משני המקורות להתפצל: צד אחד כותב, השני משקף.
  cbtSeen: null,           // {sessionsDone:[], startISO, at}
};
