  ...
  if (meta.partnerChatId) {
    ...
    return {
      text: [
        ...
        auto
          ? `ברגע שאתה לוחץ "יש לי דחף עכשיו" — או שהבוט מזהה דחף בטקסט חופשי — היא מקבלת את הדיווח <b>מיד</b>, בלי שתעשה כלום. וכשהגל נשבר, היא מקבלת גם את זה.`
          : `כרגע לא נשלח לה כלום אוטומטית. אפשר לשלוח ידנית בכפתור למטה.`,
        '',
        `<i>כדי לא להציף: לכל היותר דיווח אחד ל-30 דקות. כמה גלים באותה אפיזודה נחשבים לאחד.</i>`,
        '',
