...
export function partnerInfo(meta, code) {
  if (meta.partnerChatId) {
    ...
    return {
      text: [
        ...
        auto
          ? `ברגע שאתה לוחץ "יש לי גל" — או שהבוט מזהה דחף בטקסט חופשי — היא מקבלת את הדיווח <b>מיד</b>, בלי שתעשה כלום. וכשהגל נשבר, היא מקבלת גם את זה.`
  ...
  return {
    text: [
      ...
      '',
      `אחרי החיבור זה <b>אוטומטי</b>: לחיצה על "יש לי גל" שולחת לה מיד, בלי צעד נוסף.`,
      '',
